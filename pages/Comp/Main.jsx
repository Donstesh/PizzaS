    ...
    return (
        <motion.main animate={{ y: [1000, 0] }} transition={{ type: "spring", damping: 3, ease: [0.075, 0.82, 0.165, 1] }} >
            <div className={Styles.child_one}>
                <small>Prepare your Pizza <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#FF6D21" className="bi bi-arrow-right" viewBox="0 0 16 16">
                    <path fillRule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z" />
                </svg></small>
                <h1>Choosing Healthy and a Freshy Pizza</h1>
                <div>
                    <motion.button animate={{ scale: [.9, 1, .9] }} transition={{ repeat : Infinity}} onClick={() => {
                        toNext(1)
                    }}>Start Order</motion.button>
                </div>
            </div>
